      ...
      <Tabs defaultValue="quote" className="w-full">
        <TabsList className="grid w-full grid-cols-2 mb-8">
          ...
          <TabsTrigger value="favorites">
            Favorites {!loadingFavorites && `(${favorites.length})`}
          </TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="quote" className="space-y-4">
          ...
          <Card className={`overflow-hidden transition-all duration-300 ${animation?'scale-95 opacity-70' :'scale-100 opacity-100'}`}>
          ...
          {favorites.length === 0? (
            <Card>
              <CardContent className="flex flex-col items-center justify-center py-12">
                ...
                {/* <Button
                  variant="outline"
                  onClick={() => document.querySelector('[data-value="quote"]')?.click()}
                >
